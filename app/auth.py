...
ALLOW_CANDIDATE_ROLES = [ROLE_ADMIN, ROLE_APPROVER]
ALLOW_ARCHIVE_VIEW_ROLES = [ROLE_ADMIN, ROLE_APPROVER, ROLE_USER]
ALLOW_ARCHIVE_EXPORT_ROLES = [ROLE_ADMIN, ROLE_APPROVER]
ALLOW_ARCHIVE_AUDIT_ROLES = [ROLE_ADMIN]
ALLOW_ARCHIVE_CANCEL_ROLES = [ROLE_ADMIN, ROLE_APPROVER]
ALLOW_ARCHIVE_EXECUTE_ROLES = [ROLE_ADMIN, ROLE_APPROVER]
